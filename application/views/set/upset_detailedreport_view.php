...
<body>
	...
	<table class="records">
		<tr>
		<td colspan="9"><br/>
		&nbsp; &nbsp; 0 - [No Respnse] &nbsp; &nbsp; 1 - [Very much] &nbsp; &nbsp; 2 - [Much] &nbsp;&nbsp; 3 - [Moderately] &nbsp;&nbsp; 4 - [Little] &nbsp;&nbsp; 5 - [Not at all]
		<br/><br/>
		</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="10%"><?php  if($count != 0) echo round($ave1 = $sum/$count, 4); else echo $ave1 = 0;?></td>
		</tr>
		<tr>
			<td>2.</td>
			...
			<td><?php  if($count != 0) echo round($ave2 = $sum/$count, 4); else echo $ave2 = 0;?></td>
		</tr>
		<tr>
			<td>3.</td>
		...
		<tr>
			...
			<td><?php  if($count != 0) echo round($ave4 = $sum/$count, 4); else echo $ave4 = 0;?></td>
		</tr>
		<tr>
			<td>5.</td>
			<td>Do you feel that you have performed well in this course?</td>
			<td><?php echo $part1_5['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave5 = $sum/$count, 4); else echo $ave5 = 0;?></td>
		</tr>
		<tr>
			<td>6.</td>
			<td>Have your expectations of this course been met?</td>
			<td><?php echo $part1_6['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave6 = $sum/$count, 4); else echo $ave6 = 0;?></td>
		</tr>	
		...
		<tr>
			...
			<td><?php  if($count != 0) echo round($ave7 = $sum/$count, 4); else echo $ave7 = 0;?></td>
		</tr>
		<tr>
			<td>8.</td>
			...
			<td><?php  if($count != 0) echo round($ave8 = $sum/$count, 4); else echo $ave8 = 0;?></td>
		</tr>
	</table>
	...
	<table class="records">
		...
		<tr>
			...
			<td><?php  if($count != 0) echo round($ave9 = $sum/$count, 4); else echo $ave9 = 0;?></td>
		</tr>		
	</table>
	<br/>
	<div align="right">Weighted Average (Part I): <?php echo round(($ave1+$ave2+$ave3+$ave4+$ave5+$ave6+$ave7+$ave8+$ave9)/9, 4); ?></div> 
	<br/><br/>
	...
	<table class="records">
		...
		<tr>
			<td width="2%">1.</td>
			<td width="62%">This course stimulates me to study beyond the lessons assigned.</td>
			<td width="6%"><?php echo $part2a_1['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_1['1']; $sum+= $part2a_1['1']; $count+=$part2a_1['1']; ?></td>
			<td width="6%"><?php echo $part2a_1['2']; $sum+= $part2a_1['2']*2; $count+=$part2a_1['2'];?></td>
			<td width="6%"><?php echo $part2a_1['3']; $sum+= $part2a_1['3']*3; $count+=$part2a_1['3'];?></td>
			<td width="6%"><?php echo $part2a_1['4']; $sum+= $part2a_1['4']*4; $count+=$part2a_1['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave1 = $sum/$count, 4); else echo $ave1 = 0;?></td>
		</tr>
		...
		<tr>
			...
			<td width="6%"><?php echo $part2a_2['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_2['1']; $sum+= $part2a_2['1']; $count+=$part2a_2['1']; ?></td>
			<td width="6%"><?php echo $part2a_2['2']; $sum+= $part2a_2['2']*2; $count+=$part2a_2['2'];?></td>
			<td width="6%"><?php echo $part2a_2['3']; $sum+= $part2a_2['3']*3; $count+=$part2a_2['3'];?></td>
			<td width="6%"><?php echo $part2a_2['4']; $sum+= $part2a_2['4']*4; $count+=$part2a_2['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave2 = $sum/$count, 4); else echo $ave2 = 0;?></td>
		</tr>
		
		<tr>
			<td>3.</td>
			<td>I have worked more conscientiously in this course more than in most other courses.</td>
			<td width="6%"><?php echo $part2a_3['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_3['1']; $sum+= $part2a_3['1']; $count+=$part2a_3['1']; ?></td>
			<td width="6%"><?php echo $part2a_3['2']; $sum+= $part2a_3['2']*2; $count+=$part2a_3['2'];?></td>
			<td width="6%"><?php echo $part2a_3['3']; $sum+= $part2a_3['3']*3; $count+=$part2a_3['3'];?></td>
			<td width="6%"><?php echo $part2a_3['4']; $sum+= $part2a_3['4']*4; $count+=$part2a_3['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave3 = $sum/$count, 4); else echo $ave3 = 0;?></td>
		</tr>
		
		<tr>
			<td>4.</td>
			<td>Even if this course were not required, it would still be worthwhile taking it.</td>
			<td width="6%"><?php echo $part2a_4['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_4['1']; $sum+= $part2a_4['1']; $count+=$part2a_4['1']; ?></td>
			<td width="6%"><?php echo $part2a_4['2']; $sum+= $part2a_4['2']*2; $count+=$part2a_4['2'];?></td>
			<td width="6%"><?php echo $part2a_4['3']; $sum+= $part2a_4['3']*3; $count+=$part2a_4['3'];?></td>
			<td width="6%"><?php echo $part2a_4['4']; $sum+= $part2a_4['4']*4; $count+=$part2a_4['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave4 = $sum/$count, 4); else echo $ave4 = 0;?></td>
		</tr>
		
		<tr>
			<td>5.</td>
			<td>I am fully satisfied with the way this course was handled/conducted.</td>
			<td width="6%"><?php echo $part2a_5['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_5['1']; $sum+= $part2a_5['1']; $count+=$part2a_5['1']; ?></td>
			<td width="6%"><?php echo $part2a_5['2']; $sum+= $part2a_5['2']*2; $count+=$part2a_5['2'];?></td>
			<td width="6%"><?php echo $part2a_5['3']; $sum+= $part2a_5['3']*3; $count+=$part2a_5['3'];?></td>
			<td width="6%"><?php echo $part2a_5['4']; $sum+= $part2a_5['4']*4; $count+=$part2a_5['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave5 = $sum/$count, 4); else echo $ave5 = 0;?></td>
		</tr>
		
		<tr>
			<td>6.</td>
			<td>This course stimulates me to think creatively.</td>
			<td width="6%"><?php echo $part2a_6['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_6['1']; $sum+= $part2a_6['1']; $count+=$part2a_6['1']; ?></td>
			<td width="6%"><?php echo $part2a_6['2']; $sum+= $part2a_6['2']*2; $count+=$part2a_6['2'];?></td>
			<td width="6%"><?php echo $part2a_6['3']; $sum+= $part2a_6['3']*3; $count+=$part2a_6['3'];?></td>
			<td width="6%"><?php echo $part2a_6['4']; $sum+= $part2a_6['4']*4; $count+=$part2a_6['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave6 = $sum/$count, 4); else echo $ave6 = 0;?></td>
		</tr>
		
		<tr>
			<td>7.</td>
			<td>This course develops critical thinking.</td>
			<td width="6%"><?php echo $part2a_7['NR']; ?></td>
			<td width="6%"><?php $sum = 0; $count = 0; echo $part2a_7['1']; $sum+= $part2a_7['1']; $count+=$part2a_7['1']; ?></td>
			<td width="6%"><?php echo $part2a_7['2']; $sum+= $part2a_7['2']*2; $count+=$part2a_7['2'];?></td>
			<td width="6%"><?php echo $part2a_7['3']; $sum+= $part2a_7['3']*3; $count+=$part2a_7['3'];?></td>
			<td width="6%"><?php echo $part2a_7['4']; $sum+= $part2a_7['4']*4; $count+=$part2a_7['4'];?></td>
			<td width="6%"><?php  if($count != 0) echo round($ave7 = $sum/$count, 4); else echo $ave7 = 0;?></td>
		</tr>
	</table>
	
	<br/>
	<div align="right">Weighted Average (Part II-A):  <?php echo round(($ave1+$ave2+$ave3+$ave4+$ave5+$ave6+$ave7)/7, 4); ?> </div> 
	<br/><br/>
	...
	<table class="records">
		...
		<br/><br/>
		&nbsp; &nbsp;<span style="font-size: 10px">Reverse encoding for negatively oriented questions</span>
		<br/><br/>
		</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="6%"><?php echo $part3a_1['NR']; ?></td>
			...
			<td width="6%"><?php  if($count != 0) echo round($ave[1] = $sum/$count, 4); else echo $ave[1] = 0;?></td>
		</tr>
		<tr>
			<td>2.</td>
			<td>Comes to class unprepared for the lesson.</td>
			<td><?php echo $part3a_2['NR']; ?></td>
		...
		<tr>
			...
			<td><?php  if($count != 0) echo round($ave[17] = $sum/$count, 4); else echo $ave[17] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">18.</td>
			<td width="62%">Explains the grading procedure ans standards clearly and applies them.</td>
			<td><?php echo $part3a_18['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[18] = $sum/$count, 4); else echo $ave[18] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">19.</td>
			<td width="62%">Does not invite through behaviour and general appearance.</td>
			<td><?php echo $part3a_19['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[19] = $sum/$count, 4); else echo $ave[19] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">20.</td>
			<td width="62%">Explains the grading procedure ans standards clearly and applies them.</td>
			<td><?php echo $part3a_20['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[20] = $sum/$count, 4); else echo $ave[20] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">21.</td>
			<td width="62%">Admits errors in the presentation of subject matter, and in evaluation.</td>
			<td><?php echo $part3a_21['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[21] = $sum/$count, 4); else echo $ave[21] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">22.</td>
			<td width="62%">Answers students' questions adequately.</td>
			<td><?php echo $part3a_22['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[22] = $sum/$count, 4); else echo $ave[22] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">23.</td>
			<td width="62%">Is not available for consultation.</td>
			<td><?php echo $part3a_23['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[23] = $sum/$count, 4); else echo $ave[23] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">24.</td>
			<td width="62%">Is able to make students comprehend and appreciate complex ideas.</td>
			<td><?php echo $part3a_24['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[24] = $sum/$count, 4); else echo $ave[24] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">25.</td>
			<td width="62%">Gives unreasonable course requirements and assignments.</td>
			<td><?php echo $part3a_25['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[25] = $sum/$count, 4); else echo $ave[25] = 0;?></td>
		</tr>
		<tr>
			<td width="2%">26.</td>
			<td>Uses comprehensive, up-to-date and relevant reading list.</td>
			<td><?php echo $part3a_26['NR']; ?></td>
			...
			<td><?php  if($count != 0) echo round($ave[26] = $sum/$count, 4); else echo $ave[26] = 0;?></td>
		</tr>
	</table>
	<br/>
	<div align="right">Weighted Average (Part III-A): <?php echo round(array_sum($ave)/26,4); ?> </div> 
	<br/><br/>
