<?php include('check.php');?>
	...
	<body>
		...
		<h2> Open Evaluation <?php echo "(".$user_college_name.")"; ?></h2>
		<div class="tabs">
		<table cellpadding="3">
			<tr>
			<td align = "center"><a href = "#"><div class = "selectedtabH">Open Evaluation</div></a>
			<td align = "center"><a href = "<?php echo base_url('index.php/clerk/evaluationmanagement/close');?>"><div class = "tabH">Close Evaluation</div></a>
			</tr>
		</table>
		</div><br/>
		<?php echo form_open('clerk/evaluationmanagement/searchopen', array('onSubmit'=>true)); ?>
		...
		<?php
			if(isset($records))
			{
				...
				echo "</table>";
				echo "<table><tr><td><br><input type = 'submit' value = 'Open evaluation mode'></tr></table>";
				echo form_close();
			}
			else
